...
import {Container,VideoServersContainer,ServersButtonsContainer,ServerButton,VideoWatchContainer,NextPrevContainer,NextPrevButton,VidoeContainer} from '@/app/(anime)/watch/[name]/[epname]/Style'
